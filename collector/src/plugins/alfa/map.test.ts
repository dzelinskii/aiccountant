...
test('лимит сходится на числах живой карты с ненулевыми холдами', () => {
  // холды в коде не читаются — они сокращаются в самой разности. Числа взяты с
  // живой карты, где холды были ненулевыми, так что фикстура это свидетельство
  // замера, а не проверка гипотезы про холды
