...
//
// Подгруппой различается только входящая сторона. Исходящий перевод себе банк
// кладёт в ту же F1, что и перевод человеку, и здесь эту таблицу дополнять
// нечем — его различает isInner, см. refineOwnTransfer ниже.
//
