...
export interface CollectedAccount {
  ...
  balance: string | null
  /**
   * Кредитный лимит строкой; null — счёт не кредитный либо банк лимита не
   * сообщил. Вместе с остатком (чистой позицией) даёт «доступно к трате»,
   * поэтому считать его приложение может только из пары одного сбора.
   */
