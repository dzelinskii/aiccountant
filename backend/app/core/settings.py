...
class Settings(BaseSettings):
    ...
    # кап на объём текста выписки, уходящий в LLM (символы). Дефолт консервативный:
    # ответ модели тоже ограничен, а обрезанный JSON выглядит как «непонятный ответ»
    # вместо честного «слишком большая выписка». Калибруется на реальных выписках.
    import_max_text_chars: int = 20000
