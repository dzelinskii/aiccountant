...
async def _observe_credit_limit(
    ...
    if latest is not None and observed_at <= latest.confirmed_at:
        # наблюдение из прошлого не переписывает настоящее — тем же правилом,
        # по которому не едет назад остаток
        return
